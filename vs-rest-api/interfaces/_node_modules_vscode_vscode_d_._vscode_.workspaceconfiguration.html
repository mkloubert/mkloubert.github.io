...
<head>
	...
	<title>WorkspaceConfiguration | @types/node</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html">WorkspaceConfiguration</a>
				</li>
			</ul>
...
<span class="hljs-keyword">const</span> values = config.get(<span class="hljs-string">'configurations'</span>);
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external"><a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#get" class="tsd-kind-icon">get</a></li>
								<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#has" class="tsd-kind-icon">has</a></li>
								<li class="tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external"><a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#inspect" class="tsd-kind-icon">inspect</a></li>
								<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#update" class="tsd-kind-icon">update</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-external">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in node_modules/vscode/vscode.d.ts:3524</li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
						...
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in node_modules/vscode/vscode.d.ts:3533</li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in node_modules/vscode/vscode.d.ts:3541</li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
					...
					<h3>inspect</h3>
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
						<li class="tsd-signature tsd-kind-icon">inspect&lt;T&gt;<span class="tsd-signature-symbol">(</span>section<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">undefined</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in node_modules/vscode/vscode.d.ts:3560</li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					...
					<h3>update</h3>
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
						<li class="tsd-signature tsd-kind-icon">update<span class="tsd-signature-symbol">(</span>section<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, configurationTarget<span class="tsd-signature-symbol">?: </span><a href="../enums/_node_modules_vscode_vscode_d_._vscode_.configurationtarget.html" class="tsd-signature-type">ConfigurationTarget</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_node_modules_vscode_vscode_d_.thenable.html" class="tsd-signature-type">Thenable</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in node_modules/vscode/vscode.d.ts:3596</li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
							...
							<ul class="tsd-parameters">
								...
								<li>
									<h5><span class="tsd-flag ts-flagOptional">Optional</span> configurationTarget: <a href="../enums/_node_modules_vscode_vscode_d_._vscode_.configurationtarget.html" class="tsd-signature-type">ConfigurationTarget</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">boolean</span></h5>
									<div class="tsd-comment tsd-typography">
										<p>The <a href="#ConfigurationTarget">configuration target</a> or a boolean value.</p>
...
`<span class="javascript">ConfigurationTarget.Workspace</span>` otherwise.
							...
							<h4 class="tsd-returns-title">Returns <a href="_node_modules_vscode_vscode_d_.thenable.html" class="tsd-signature-type">Thenable</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
						</li>
					</ul>
				</section>
			</section>
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface tsd-parent-kind-module tsd-is-external">
						<a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html" class="tsd-kind-icon">Workspace<wbr>Configuration</a>
						<ul>
							<li class=" tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
								<a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#get" class="tsd-kind-icon">get</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
								<a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#has" class="tsd-kind-icon">has</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
								<a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#inspect" class="tsd-kind-icon">inspect</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
								<a href="_node_modules_vscode_vscode_d_._vscode_.workspaceconfiguration.html#update" class="tsd-kind-icon">update</a>
							</li>
						</ul>
					</li>
				</ul>
